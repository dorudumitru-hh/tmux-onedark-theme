...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_comment_grey,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_comment_grey,bold]  #(whoami) "
set "status-left" "#[fg=$onedark_black,bg=$onedark_comment_grey,bold] #S #{prefix_highlight}#[fg=$onedark_comment_grey,bg=$onedark_black,nobold,nounderscore,noitalics]"
